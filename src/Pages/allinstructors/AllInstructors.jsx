...
const AllInstructors = () => {
  ...
  const displayedInstructors = showAll ? AllInstructors : AllInstructors.slice(0, 6);
  ...
  return (
    <div style={{ ...styles, marginBottom: '-48px', paddingBottom: '70px' }}>
      <h1 className='text-center fw-semibold text-white' style={{ paddingTop: '130px', paddingBottom: '50px' }}>ALL INSTRUCTORS</h1>
      <Container>
